...
| Field | Value |
|---|---|
| Sprint | Run after Sprint 6 (see Timing section) |
| Start | After Sprint 6 `dev` merge |
| End | Complete ✅ 2026-04-06 |
...
|---|---|---|---|
| S-UX-1 | F3 | Merge Generate Draft + Improve + Expand to Prose into one smart `✨ Write` button | ✅ Done (#63) |
| S-UX-2 | F3-11 | Demote Key Points — move to Notes field as `💡 Suggest outline` helper link | ✅ Done (#64) |
| S-UX-3 | F17-1 | Relocate Grammar Check out of AI actions row → section header icon | ✅ Done (#65) |
| S-UX-4 | F3-11 | Relabel context inputs — clarify Notes vs Add Your Data purpose | ✅ Done (#66) |
| S-UX-5 | F3 | Update E2E tests for new button structure | ✅ Done (#67) |
